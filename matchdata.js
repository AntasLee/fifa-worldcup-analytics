...
const wc2026MatchDetails = { // V1.78: 助攻数据已全面补全, gkSaves精确数据12场已录入
  ...
  "2026|I|NOR|SEN": {
    score: { sh: 3, sa: 2 },
    goals: [
      { min: 43,    side: "home", scorer: "马库斯·彼得森 (Marcus Pedersen)", type: "shot" },
      { min: 48,    side: "home", scorer: "哈兰德 (Erling Haaland)",  type: "shot", assist: "厄德高 (Martin Ødegaard)" },
      { min: 53,    side: "away", scorer: "伊斯梅拉·萨尔 (Ismaïla Sarr)", type: "shot", assist: "萨迪奥·马内 (Sadio Mané)" },
      { min: 58,    side: "home", scorer: "哈兰德 (Erling Haaland)",  type: "shot", assist: "帕特里克·贝格 (Patrick Berg)" },
      { min: "90+3",side: "away", scorer: "伊斯梅拉·萨尔 (Ismaïla Sarr)", type: "shot", assist: "尼古拉斯·杰克逊 (Nicolas Jackson)" }
    ],
    cards: { home: { yellow: 0, red: 0 }, away: { yellow: 0, red: 0 } },
    attendance: null, referee: "Wilton Sampaio (BRA)"
  },
  ...
  "2026|K|POR|UZB": {
    score: { sh: 5, sa: 0 },
    gkSaves: { home: { name: "Diogo Costa", nameZh: "迪奥戈·科斯塔", saves: 2 }, away: { name: "Abduvohid Nematov", nameZh: "阿卜杜沃赫德·内马托夫", saves: 4 } },
    goals: [
      { min: 6,  side: "home", scorer: "克里斯蒂亚诺·罗纳尔多 (Cristiano Ronaldo)", type: "shot", assist: "若昂·坎塞洛 (João Cancelo)" },
      { min: 17, side: "home", scorer: "努诺·门德斯 (Nuno Mendes)", type: "free_kick" },
      { min: 39, side: "home", scorer: "克里斯蒂亚诺·罗纳尔多 (Cristiano Ronaldo)", type: "shot", assist: "布鲁诺·费尔南德斯 (Bruno Fernandes)" },
      { min: 60, side: "away", scorer: "阿卜杜沃赫德·内马托夫 (Abduvohid Nematov)", type: "own_goal" },
      { min: 87, side: "home", scorer: "拉斐尔·莱奥 (Rafael Leão)", type: "shot" }
    ],
    cards: { home: { yellow: 1, red: 0 }, away: { yellow: 1, red: 0 } },
    attendance: null, referee: "Jalal Jayed (MAR)"
  },
  ...
  "2026|L|PAN|CRO": {
    score: { sh: 0, sa: 1 },
    goals: [
      { min: 54, side: "away", scorer: "安特·布迪米尔 (Ante Budimir)", type: "shot", assist: "约瑟普·斯塔尼希奇 (Josip Stanišić)" }
    ],
    cards: { home: { yellow: 1, red: 0 }, away: { yellow: 1, red: 0 } },
    attendance: null, referee: "TBD"
  },
  ...
  // ========= SF 半决赛 — 7月15日 =========
  // M101 · 7月15日 03:00 · AT&T体育场 (达拉斯)
  "2026|SF|FRA|ESP": {
    score: { sh: 0, sa: 2 },
    goals: [
      { min: 22, side: "away", scorer: "米克尔·奥亚萨瓦尔 (Mikel Oyarzabal)", type: "penalty" },
      { min: 58, side: "away", scorer: "佩德罗·波罗 (Pedro Porro)", type: "shot", assist: "达尼·奥尔莫 (Dani Olmo)" }
    ],
    cards: { home: { yellow: 2, red: 0 }, away: { yellow: 1, red: 0 } },
...
matchStats["2026|I|NOR|SEN"] = {p1:"42%",p2:"58%",ps1:null,ps2:null,sh1:10,sh2:11,so1:7,so2:4,sb1:3,sb2:7,co1:5,co2:4,fo1:13,fo2:5,os1:0,os2:4,yc1:0,yc2:0,rc1:0,rc2:0,tk1:null,tk2:null,at1:87,at2:100,da1:32,da2:60,pk1:0,pk2:0};
...
matchStats["2026|J|JOR|ALG"] = {p1:"28%",p2:"72%",ps1:null,ps2:null,sh1:8,sh2:12,so1:4,so2:8,sb1:4,sb2:4,co1:1,co2:10,fo1:11,fo2:6,os1:1,os2:0,yc1:1,yc2:1,rc1:0,rc2:0,tk1:null,tk2:null,at1:66,at2:152,da1:24,da2:75,pk1:0,pk2:0};
...
matchStats["2026|K|POR|UZB"] = {p1:"66%",p2:"34%",ps1:null,ps2:null,sh1:14,sh2:4,so1:9,so2:2,sb1:5,sb2:2,co1:3,co2:2,fo1:14,fo2:15,os1:2,os2:2,yc1:1,yc2:1,rc1:0,rc2:0,tk1:null,tk2:null,at1:144,at2:79,da1:60,da2:25,pk1:0,pk2:0};
