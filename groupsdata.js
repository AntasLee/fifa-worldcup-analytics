...
function getGMTBJ(gid,mi){const t={A:['6月12日 03:00','6月12日 10:00','6月19日 00:00','6月19日 09:00','6月25日 09:00','6月25日 09:00'],B:['6月13日 03:00','6月14日 03:00','6月19日 03:00','6月19日 06:00','6月25日 03:00','6月25日 03:00'],C:['6月14日 06:00','6月14日 09:00','6月20日 06:00','6月20日 09:00','6月25日 06:00','6月25日 06:00'],D:['6月13日 09:00','6月14日 12:00','6月20日 03:00','6月21日 00:00','6月26日 10:00','6月26日 10:00'],E:['6月15日 01:00','6月15日 07:00','6月21日 04:00','6月21日 08:00','6月26日 04:00','6月26日 04:00'],F:['6月15日 04:00','6月15日 10:00','6月21日 01:00','6月22日 00:00','6月26日 07:00','6月26日 07:00'],G:['6月16日 03:00','6月17日 00:00','6月22日 03:00','6月22日 09:00','6月27日 11:00','6月27日 11:00'],H:['6月16日 00:00','6月16日 06:00','6月22日 00:00','6月22日 06:00','6月27日 08:00','6月27日 08:00'],I:['6月17日 03:00','6月17日 06:00','6月23日 05:00','6月23日 08:00','6月27日 03:00','6月27日 03:00'],J:['6月17日 09:00','6月18日 00:00','6月23日 01:00','6月23日 11:00','6月28日 10:00','6月28日 10:00'],K:['6月18日 01:00','6月18日 10:00','6月24日 01:00','6月24日 10:00','6月28日 07:30','6月28日 07:30'],L:['6月18日 04:00','6月18日 07:00','6月24日 04:00','6月24日 07:00','6月28日 05:00','6月28日 05:00']};return t[gid]?t[gid][mi]:'待定';}
...
function getPlayerKey(displayName) {
    ...
    // ★ V1.71 修复: 去除常见姓名后缀 (对所有输入格式生效，不仅限于括号格式)
    ...
    if (parenIdx >= 0) {
        ...
        // ★ V1.71 修复: 去除常见姓名后缀 (Jr, Sr, II, III, Júnior 等)
        ...
        // ★ V1.71 修复: 尝试交换名姓顺序 ("Hwang In-beom" ↔ "In-beom Hwang")
        ...
        if (enWords.length >= 2) {
            ...
            // ★ V1.71 修复: 连字符名处理 — 尝试去连字符版本 ("In-beom" → "Inbeom")
    ...
    // V1.71 添加最低相关性要求，避免短查询误匹配（如"希门尼斯"误匹配到"Emam Ashour"）
    if (lower.length >= 3) {
        for (var key in playerDB) {
            var pd = playerDB[key];
            // 精确子串匹配
...
window.makePlayerClickable = function(displayName) {
    ...
    // ★ V1.71 修复: 如果 key 为空且 displayName 包含括号，提取英文名作为回退
...
window.searchPlayer = function() {
    ...
    if (matches.length === 1) {
        // V1.71 增强相关性验证：短查询(≤3字符)要求更高相关性，避免子串误匹配
    ...
    // 尝试在比赛数据中搜索 scorer（V1.71: 仅当查询≥3字符且匹配整个单词时才触发，避免误匹配）
