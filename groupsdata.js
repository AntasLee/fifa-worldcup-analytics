...
function getGMTBJ(gid,mi){const t={A:['6月12日 03:00','6月12日 10:00','6月19日 00:00','6月19日 09:00','6月25日 09:00','6月25日 09:00'],B:['6月13日 03:00','6月14日 03:00','6月19日 03:00','6月19日 06:00','6月25日 03:00','6月25日 03:00'],C:['6月14日 06:00','6月14日 09:00','6月20日 06:00','6月20日 08:30','6月25日 06:00','6月25日 06:00'],D:['6月13日 09:00','6月14日 12:00','6月20日 03:00','6月20日 11:00','6月26日 10:00','6月26日 10:00'],E:['6月15日 01:00','6月15日 07:00','6月21日 04:00','6月21日 08:00','6月26日 04:00','6月26日 04:00'],F:['6月15日 04:00','6月15日 10:00','6月21日 01:00','6月21日 12:00','6月26日 07:00','6月26日 07:00'],G:['6月16日 03:00','6月16日 09:00','6月22日 03:00','6月22日 09:00','6月27日 11:00','6月27日 11:00'],H:['6月16日 00:00','6月16日 06:00','6月22日 00:00','6月22日 06:00','6月27日 08:00','6月27日 08:00'],I:['6月17日 03:00','6月17日 06:00','6月23日 05:00','6月23日 08:00','6月27日 03:00','6月27日 03:00'],J:['6月17日 09:00','6月17日 12:00','6月23日 01:00','6月23日 11:00','6月28日 10:00','6月28日 10:00'],K:['6月18日 01:00','6月18日 10:00','6月24日 01:00','6月24日 10:00','6月28日 07:30','6月28日 07:30'],L:['6月18日 04:00','6月18日 07:00','6月24日 04:00','6月24日 07:00','6月28日 05:00','6月28日 05:00']};return t[gid]?t[gid][mi]:'待定';}
function getKOTime(sid,i){const t={R32:['6月30日 04:30','7月1日 05:00','6月29日 03:00','6月30日 09:00','6月30日 01:00','7月1日 01:00','7月1日 09:00','7月2日 00:00','7月3日 07:00','7月3日 03:00','7月2日 08:00','7月2日 04:00','7月4日 06:00','7月4日 02:00','7月3日 11:00','7月4日 09:30'],R16:['7月5日 01:00','7月5日 05:00','7月6日 04:00','7月6日 08:00','7月7日 03:00','7月7日 05:00','7月8日 00:00','7月8日 04:00'],QF:['7月10日 04:00','7月12日 05:00','7月11日 03:00','7月12日 09:00'],SF:['7月15日 03:00','7月16日 03:00'],TP:['7月19日 05:00'],FINAL:['7月20日 03:00']};const a=t[sid];return a&&i<a.length?a[i]:'待定';}
...
function genKOs(){const ms=[];koRounds.forEach(r=>{for(let i=1;i<=r.count;i++){const m={id:r.id+'_'+i,sid:r.id,sn:r.name,time:getKOTime(r.id,i-1),tA:null,tB:null,sA:null,sB:null,w:null,af:true};if(r.id==='R32'&&i<=r32s.length){m.sA=r32s[i-1].a;m.sB=r32s[i-1].b;}ms.push(m);}});return ms;}
	let koMs=genKOs();
		...
		// ========== 淘汰赛胜者自动晋级（通用辅助函数） ==========
		// 双向查找赛果数据（兼容 tA/tB 与 matchdata 中 team 顺序不一致的情况）
		function lookupMatchData(stage, code1, code2){
			var key1='2026|'+stage+'|'+code1+'|'+code2;
			var key2='2026|'+stage+'|'+code2+'|'+code1;
			if(typeof wc2026MatchDetails!=='undefined'){
				var fin=wc2026MatchDetails[key1]||wc2026MatchDetails[key2];
				if(fin&&fin.score) return fin;
			}
			var wcData=window.wc2026AllMatches||{};
			var fin2=wcData[key1]||wcData[key2];
			if(fin2&&fin2.score) return fin2;
			return null;
		}
		// 从 wc2026AllMatches / wc2026MatchDetails 读取比分，返回胜者球队 code
		function getKOWinner(mid, stage, tA, tB){
			var fin=lookupMatchData(stage, tA, tB);
			if(!fin) return null;
			var sh=fin.score.sh, sa=fin.score.sa;
			var sc120=fin.score120;
			var pk=fin.penaltyScore;
			// 注意：赛果中的 home/away 对应 matchdata key 中的第一/第二队，而非 tA/tB
			// key 可能是 tA|tB 或 tB|tA，需根据实际 key 判断胜者
			var keyWithTA='2026|'+stage+'|'+tA+'|'+tB;
			var isTAFirst=false;
			if(typeof wc2026MatchDetails!=='undefined'&&wc2026MatchDetails[keyWithTA]) isTAFirst=true;
			else{var wcData=window.wc2026AllMatches||{};if(wcData[keyWithTA]) isTAFirst=true;}
			if(pk){
				if(isTAFirst) return pk.home>pk.away?tA:tB;
				else return pk.home>pk.away?tB:tA;
			}
			if(sc120){
				if(isTAFirst) return sc120.sh>sc120.sa?tA:tB;
				else return sc120.sh>sc120.sa?tB:tA;
			}
			if(isTAFirst){ return sh>sa?tA:(sa>sh?tB:null); }
			else{ return sh>sa?tB:(sa>sh?tA:null); }
		}
		...
		// R16 → QF 胜者自动晋级
		// QF_1←(R16_2,R16_1) 法国主·摩洛哥客, QF_2←(R16_3,R16_4), QF_3←(R16_5,R16_6), QF_4←(R16_7,R16_8)
		function propagateR16ToQF(){
			...
			var qfMap={QF_1:['R16_2','R16_1']};
			for(var n=2;n<=4;n++){ qfMap['QF_'+n]=['R16_'+(2*n-1),'R16_'+(2*n)]; }
			fillDownstreamTeams(qfMap, r16Winners);
		}

		// QF → SF 胜者自动晋级
		// SF_1←(QF_1,QF_3) 法/西, SF_2←(QF_2,QF_4) 英/阿 (48队交叉落位)
		function propagateQFToSF(){
			...
			var sfMap={SF_1:['QF_1','QF_3'],SF_2:['QF_2','QF_4']};
...
const koByStage={};koMs.forEach(m=>{if(!koByStage[m.sid])koByStage[m.sid]=[];koByStage[m.sid].push(m);});var koSortFn=function(a,b){var pa=a.time.split(/[月日 ]/),pb=b.time.split(/[月日 ]/);return(pa[0].padStart(2,'0')+pa[1].padStart(2,'0')+(pa[3]||'').replace(':','')).localeCompare(pb[0].padStart(2,'0')+pb[1].padStart(2,'0')+(pb[3]||'').replace(':',''));};['R32','R16','QF','SF','TP','FINAL'].forEach(function(s){if(koByStage[s])koByStage[s].sort(koSortFn);});
...
var _ANC_W=["A","B","D","E","G","I","K","L"],_ANC_R=["EJIFHGLK","HGIDJFLK","EJIDHGLK","EJIDHFLK","EGIDJFLK","EGJDHFLK","EGIDHFLK","EGJDHFLI","EGJDHFIK","HGICJFLK","EJICHGLK","EJICHFLK","EGICJFLK","EGJCHFLK","EGICHFLK","EGJCHFLI","EGJCHFIK","HGICJDLK","CJIDHFLK","CGIDJFLK","CGJDHFLK","CGIDHFLK","CGJDHFLI","CGJDHFIK","EJICHDLK","EGICJDLK","EGJCHDLK","EGICHDLK","EGJCHDLI","EGJCHDIK","CJEDIFLK","CJEDHFLK","CEIDHFLK","CJEDHFLI","CJEDHFIK","CGEDJFLK","CGEDIFLK","CGEDJFLI","CGEDJFIK","CGEDHFLK","CGJDHFLE","CGJDHFEK","CGEDHFLI","CGEDHFIK","CGJDHFEI","HJBFIGLK","EJIBHGLK","EJBFIHLK","EJBFIGLK","EJBFHGLK","EGBFIHLK","EJBFHGLI","EJBFHGIK","HJBDIGLK","HJBDIFLK","IGBDJFLK","HGBDJFLK","HGBDIFLK","HGBDJFLI","HGBDJFIK","EJBDIHLK","EJBDIGLK","EJBDHGLK","EGBDIHLK","EJBDHGLI","EJBDHGIK","EJBDIFLK","EJBDHFLK","EIBDHFLK","EJBDHFLI","EJBDHFIK","EGBDJFLK","EGBDIFLK","EGBDJFLI","EGBDJFIK","EGBDHFLK","HGBDJFLE","HGBDJFEK","EGBDHFLI","EGBDHFIK","HGBDJFEI","HJBCIGLK","HJBCIFLK","IGBCJFLK","HGBCJFLK","HGBCIFLK","HGBCJFLI","HGBCJFIK","EJBCIHLK","EJBCIGLK","EJBCHGLK","EGBCIHLK","EJBCHGLI","EJBCHGIK","EJBCIFLK","EJBCHFLK","EIBCHFLK","EJBCHFLI","EJBCHFIK","EGBCJFLK","EGBCIFLK","EGBCJFLI","EGBCJFIK","EGBCHFLK","HGBCJFLE","HGBCJFEK","EGBCHFLI","EGBCHFIK","HGBCJFEI","HJBCIDLK","IGBCJDLK","HGBCJDLK","HGBCIDLK","HGBCJDLI","HGBCJDIK","CJBDIFLK","CJBDHFLK","CIBDHFLK","CJBDHFLI","CJBDHFIK","CGBDJFLK","CGBDIFLK","CGBDJFLI","CGBDJFIK","CGBDHFLK","CGBDHFLJ","HGBCJFDK","CGBDHFLI","CGBDHFIK","HGBCJFDI","EJBCIDLK","EJBCHDLK","EIBCHDLK","EJBCHDLI","EJBCHDIK","EGBCJDLK","EGBCIDLK","EGBCJDLI","EGBCJDIK","EGBCHDLK","HGBCJDLE","HGBCJDEK","EGBCHDLI","EGBCHDIK","HGBCJDEI","CJBDEFLK","CEBDIFLK","CJBDEFLI","CJBDEFIK","CEBDHFLK","CJBDHFLE","CJBDHFEK","CEBDHFLI","CEBDHFIK","CJBDHFEI","CGBDEFLK","CGBDJFLE","CGBDJFEK","CGBDEFLI","CGBDEFIK","CGBDJFEI","CGBDHFLE","CGBDHFEK","HGBCJFDE","CGBDHFEI","HJIFAGLK","EJIAHGLK","EJIFAHLK","EJIFAGLK","EGJFAHLK","EGIFAHLK","EGJFAHLI","EGJFAHIK","HJIDAGLK","HJIDAFLK","IGJDAFLK","HGJDAFLK","HGIDAFLK","HGJDAFLI","HGJDAFIK","EJIDAHLK","EJIDAGLK","EGJDAHLK","EGIDAHLK","EGJDAHLI","EGJDAHIK","EJIDAFLK","HJEDAFLK","HEIDAFLK","HJEDAFLI","HJEDAFIK","EGJDAFLK","EGIDAFLK","EGJDAFLI","EGJDAFIK","HGEDAFLK","HGJDAFLE","HGJDAFEK","HGEDAFLI","HGEDAFIK","HGJDAFEI","HJICAGLK","HJICAFLK","IGJCAFLK","HGJCAFLK","HGICAFLK","HGJCAFLI","HGJCAFIK","EJICAHLK","EJICAGLK","EGJCAHLK","EGICAHLK","EGJCAHLI","EGJCAHIK","EJICAFLK","HJECAFLK","HEICAFLK","HJECAFLI","HJECAFIK","EGJCAFLK","EGICAFLK","EGJCAFLI","EGJCAFIK","HGECAFLK","HGJCAFLE","HGJCAFEK","HGECAFLI","HGECAFIK","HGJCAFEI","HJICADLK","IGJCADLK","HGJCADLK","HGICADLK","HGJCADLI","HGJCADIK","CJIDAFLK","HJFCADLK","HFICADLK","HJFCADLI","HJFCADIK","CGJDAFLK","CGIDAFLK","CGJDAFLI","CGJDAFIK","HGFCADLK","CGJDAFLH","HGJCAFDK","HGFCADLI","HGFCADIK","HGJCAFDI","EJICADLK","HJECADLK","HEICADLK","HJECADLI","HJECADIK","EGJCADLK","EGICADLK","EGJCADLI","EGJCADIK","HGECADLK","HGJCADLE","HGJCADEK","HGECADLI","HGECADIK","HGJCADEI","CJEDAFLK","CEIDAFLK","CJEDAFLI","CJEDAFIK","HEFCADLK","HJFCADLE","HJECAFDK","HEFCADLI","HEFCADIK","HJECAFDI","CGEDAFLK","CGJDAFLE","CGJDAFEK","CGEDAFLI","CGEDAFIK","CGJDAFEI","HGFCADLE","HGECAFDK","HGJCAFDE","HGECAFDI","HJBAIGLK","HJBAIFLK","IJBFAGLK","HJBFAGLK","HGBAIFLK","HJBFAGLI","HJBFAGIK","EJBAIHLK","EJBAIGLK","EJBAHGLK","EGBAIHLK","EJBAHGLI","EJBAHGIK","EJBAIFLK","EJBFAHLK","EIBFAHLK","EJBFAHLI","EJBFAHIK","EJBFAGLK","EGBAIFLK","EJBFAGLI","EJBFAGIK","EGBFAHLK","HJBFAGLE","HJBFAGEK","EGBFAHLI","EGBFAHIK","HJBFAGEI","IJBDAHLK","IJBDAGLK","HJBDAGLK","IGBDAHLK","HJBDAGLI","HJBDAGIK","IJBDAFLK","HJBDAFLK","HIBDAFLK","HJBDAFLI","HJBDAFIK","FJBDAGLK","IGBDAFLK","FJBDAGLI","FJBDAGIK","HGBDAFLK","HGBDAFLJ","HGBDAFJK","HGBDAFLI","HGBDAFIK","HGBDAFIJ","EJBAIDLK","EJBDAHLK","EIBDAHLK","EJBDAHLI","EJBDAHIK","EJBDAGLK","EGBAIDLK","EJBDAGLI","EJBDAGIK","EGBDAHLK","HJBDAGLE","HJBDAGEK","EGBDAHLI","EGBDAHIK","HJBDAGEI","EJBDAFLK","EIBDAFLK","EJBDAFLI","EJBDAFIK","HEBDAFLK","HJBDAFLE","HJBDAFEK","HEBDAFLI","HEBDAFIK","HJBDAFEI","EGBDAFLK","EGBDAFLJ","EGBDAFJK","EGBDAFLI","EGBDAFIK","EGBDAFIJ","HGBDAFLE","HGBDAFEK","HGBDAFEJ","HGBDAFEI","IJBCAHLK","IJBCAGLK","HJBCAGLK","IGBCAHLK","HJBCAGLI","HJBCAGIK","IJBCAFLK","HJBCAFLK","HIBCAFLK","HJBCAFLI","HJBCAFIK","CJBFAGLK","IGBCAFLK","CJBFAGLI","CJBFAGIK","HGBCAFLK","HGBCAFLJ","HGBCAFJK","HGBCAFLI","HGBCAFIK","HGBCAFIJ","EJBAICLK","EJBCAHLK","EIBCAHLK","EJBCAHLI","EJBCAHIK","EJBCAGLK","EGBAICLK","EJBCAGLI","EJBCAGIK","EGBCAHLK","HJBCAGLE","HJBCAGEK","EGBCAHLI","EGBCAHIK","HJBCAGEI","EJBCAFLK","EIBCAFLK","EJBCAFLI","EJBCAFIK","HEBCAFLK","HJBCAFLE","HJBCAFEK","HEBCAFLI","HEBCAFIK","HJBCAFEI","EGBCAFLK","EGBCAFLJ","EGBCAFJK","EGBCAFLI","EGBCAFIK","EGBCAFIJ","HGBCAFLE","HGBCAFEK","HGBCAFEJ","HGBCAFEI","IJBCADLK","HJBCADLK","HIBCADLK","HJBCADLI","HJBCADIK","CJBDAGLK","IGBCADLK","CJBDAGLI","CJBDAGIK","HGBCADLK","HGBCADLJ","HGBCADJK","HGBCADLI","HGBCADIK","HGBCADIJ","CJBDAFLK","CIBDAFLK","CJBDAFLI","CJBDAFIK","HFBCADLK","CJBDAFLH","HJBCAFDK","HFBCADLI","HFBCADIK","HJBCAFDI","CGBDAFLK","CGBDAFLJ","CGBDAFJK","CGBDAFLI","CGBDAFIK","CGBDAFIJ","CGBDAFLH","HGBCAFDK","HGBCAFDJ","HGBCAFDI","EJBCADLK","EIBCADLK","EJBCADLI","EJBCADIK","HEBCADLK","HJBCADLE","HJBCADEK","HEBCADLI","HEBCADIK","HJBCADEI","EGBCADLK","EGBCADLJ","EGBCADJK","EGBCADLI","EGBCADIK","EGBCADIJ","HGBCADLE","HGBCADEK","HGBCADEJ","HGBCADEI","CEBDAFLK","CJBDAFLE","CJBDAFEK","CEBDAFLI","CEBDAFIK","CJBDAFEI","HFBCADLE","HEBCAFDK","HJBCAFDE","HEBCAFDI","CGBDAFLE","CGBDAFEK","CGBDAFEJ","CGBDAFEI","HGBCAFDE"];
var _ANC_M={};_ANC_R.forEach(function(r){_ANC_M[r.split('').sort().join('')]=r;});
var _ANC_W2S={A:6,B:14,D:10,E:0,G:11,I:1,K:15,L:7};
function allocK3(rt){var q=rt.map(function(t){return t.group;}).sort().join('');var row=_ANC_M[q];if(!row)return null;var a={};for(var i=0;i<8;i++){var si=_ANC_W2S[_ANC_W[i]],tg=row[i];for(var j=0;j<rt.length;j++){if(rt[j].group===tg){a[si]=rt[j];break;}}}return a;}
function autoFillKO(){let ch=false;const allStands={};'ABCDEFGHIJKL'.split('').forEach(function(gid){allStands[gid]=compStands(gid);});const allComp='ABCDEFGHIJKL'.split('').every(function(g){return !!allStands[g];});var rankedThirds=null,thirdAssign=null;if(allComp){var thirds=[];'ABCDEFGHIJKL'.split('').forEach(function(gid){const ms=mByGroup[gid];const ts=groupsData.find(function(g){return g.id===gid;}).teams;const st={};ts.forEach(function(t){st[t.code]={t:t,pts:0,gf:0,ga:0};});let done=true;ms.forEach(function(m){var mk='2026|'+m.gid+'|'+m.home.code+'|'+m.away.code;var fin=(typeof wc2026MatchDetails!=='undefined'&&wc2026MatchDetails[mk]);if(fin){var sh=fin.score.sh,sa=fin.score.sa;st[m.home.code].gf+=sh;st[m.home.code].ga+=sa;st[m.away.code].gf+=sa;st[m.away.code].ga+=sh;if(sh>sa)st[m.home.code].pts+=3;else if(sa>sh)st[m.away.code].pts+=3;else{st[m.home.code].pts+=1;st[m.away.code].pts+=1;}}else{const p=gPreds[m.id];if(!p||p.sh==null||p.sa==null){done=false;return;}st[m.home.code].gf+=p.sh;st[m.home.code].ga+=p.sa;st[m.away.code].gf+=p.sa;st[m.away.code].ga+=p.sh;if(p.sh>p.sa)st[m.home.code].pts+=3;else if(p.sa>p.sh)st[m.away.code].pts+=3;else{st[m.home.code].pts+=1;st[m.away.code].pts+=1;}}});if(!done)return;const arr=Object.values(st);arr.forEach(function(s){s.gd=s.gf-s.ga;});arr.sort(function(a,b){return b.pts-a.pts||b.gd-a.gd||b.gf-a.gf;});thirds.push({group:gid,team:arr[2].t,pts:arr[2].pts,gd:arr[2].gd,gf:arr[2].gf});});thirds.sort(function(a,b){return b.pts-a.pts||b.gd-a.gd||b.gf-a.gf;});rankedThirds=thirds.slice(0,8);thirdAssign=allocK3(rankedThirds);}koMs.forEach(function(m,i){if(!m.sA||!m.sB)return;const sA=allStands[m.sA.g];if(!sA)return;const tA=sA[m.sA.p-1];if(!tA)return;var tB=null;if(m.sB.g==='*'){if(!thirdAssign||!thirdAssign[i])return;tB=thirdAssign[i].team;}else{const sB=allStands[m.sB.g];if(!sB)return;tB=sB[m.sB.p-1];if(!tB)return;}let p=kPreds[m.id];if(!p){p={tA:null,tB:null,sA:null,sB:null,w:null,af:true};kPreds[m.id]=p;}if(p.af===undefined)p.af=true;if(p.af){if(p.tA!==tA.code||p.tB!==tB.code){p.tA=tA.code;p.tB=tB.code;p.w=null;ch=true;}}});if(ch)saveK();}

function tdb(tc,sd){const t=tc?teamMap[tc]:null;if(!t)return '<span style="color:var(--text-secondary);flex:1;display:flex;justify-content:'+(sd==='home'?'flex-end':'flex-start')+';text-align:'+(sd==='home'?'right':'left')+';">待定</span>';const f=getFlag(t.code);return '<div class="team-block '+sd+'" style="justify-content:'+(sd==='home'?'flex-end':'flex-start')+';">'+(sd==='home'?'<div class="team-info" style="text-align:right;"><span class="team-name-zh">'+t.zh+'</span><span class="team-code">'+t.code+' · '+t.en+'</span></div><img class="team-flag" src="'+f+'" onerror="this.style.display=\'none\';" loading="lazy">':'')+(sd==='away'?'<img class="team-flag" src="'+f+'" onerror="this.style.display=\'none\';" loading="lazy"><div class="team-info" style="text-align:left;"><span class="team-name-zh">'+t.zh+'</span><span class="team-code">'+t.code+' · '+t.en+'</span></div>':'')+'</div>';}
function rSP(gid){const gr=groupsData.find(g=>g.id===gid);const ss={};gr.teams.forEach(t=>{ss[t.code]={t:t,pts:0,gf:0,ga:0,gd:0};});let hasAny=false;mByGroup[gid].forEach(m=>{var mk='2026|'+m.gid+'|'+m.home.code+'|'+m.away.code;var fin=(typeof wc2026MatchDetails!=='undefined'&&wc2026MatchDetails[mk]);if(fin){hasAny=true;var sh=fin.score.sh,sa=fin.score.sa;ss[m.home.code].gf+=sh;ss[m.home.code].ga+=sa;ss[m.away.code].gf+=sa;ss[m.away.code].ga+=sh;if(sh>sa)ss[m.home.code].pts+=3;else if(sa>sh)ss[m.away.code].pts+=3;else{ss[m.home.code].pts+=1;ss[m.away.code].pts+=1;}}else{const p=gPreds[m.id];if(!p||p.sh==null||p.sa==null)return;hasAny=true;ss[m.home.code].gf+=p.sh;ss[m.home.code].ga+=p.sa;ss[m.away.code].gf+=p.sa;ss[m.away.code].ga+=p.sh;if(p.sh>p.sa)ss[m.home.code].pts+=3;else if(p.sa>p.sh)ss[m.away.code].pts+=3;else{ss[m.home.code].pts+=1;ss[m.away.code].pts+=1;}}});Object.values(ss).forEach(s=>{s.gd=s.gf-s.ga;});const sor=Object.values(ss).sort((a,b)=>b.pts-a.pts||b.gd-a.gd||b.gf-a.gf);let rows='';sor.forEach((s,i)=>{const rc=i===0?'rank-1':i===1?'rank-2':i===2?'rank-3':'';const ac=i<=1?'advance':'';const f=getFlag(s.t.code);rows+='<tr class="'+ac+'"><td class="team-cell"><img src="'+f+'" style="width:20px;height:14px;vertical-align:middle;margin-right:6px;" onerror="this.style.display=\'none\';">'+s.t.zh+'</td><td class="pts-cell">'+s.pts+'</td><td class="gf-cell">'+s.gf+'</td><td class="ga-cell">'+s.ga+'</td><td class="gd-cell '+(s.gd>0?'gd-positive':s.gd<0?'gd-negative':'gd-zero')+'">'+(s.gd>=0?'+'+s.gd:s.gd)+'</td></tr>';});const infoNote=hasAny?'':'<div style="font-size:0.62rem;color:var(--text-secondary);text-align:center;padding:2px 0;">📝 请填写比分预测以计算积分</div>';return '<div class="standings-panel visible"><table class="standings-table"><thead><tr><th class="team-th">球队</th><th>积分</th><th>进球</th><th>失球</th><th>净胜球</th></tr></thead><tbody>'+rows+'</tbody></table>'+infoNote+'</div>';}function parseMatchTime(timeStr){try{var parts=timeStr.split(' ');var datePart=parts[0];var timePart=parts[1]||'00:00';var dp=datePart.replace('月','/').replace('日','').split('/');var month=parseInt(dp[0])||6;var day=parseInt(dp[1])||1;var tp=timePart.split(':');var hour=parseInt(tp[0])||0;var minute=parseInt(tp[1])||0;return new Date(2026,month-1,day,hour,minute);}catch(e){return null;}}
function getNearbyMatches(){var now=new Date();if(window.__nearbySimTime)now=window.__nearbySimTime;var allMatches=allGM.map(function(m){var t=parseMatchTime(m.time);if(!t)return{m:m,time:null,absDiff:Infinity,isPast:false};var diff=t.getTime()-now.getTime();return{m:m,time:t,absDiff:Math.abs(diff),isPast:diff<0};}).filter(function(x){return x.time!==null;});var pastMatches=allMatches.filter(function(x){return x.isPast;});var futureMatches=allMatches.filter(function(x){return !x.isPast;});pastMatches.sort(function(a,b){return b.time.getTime()-a.time.getTime();});futureMatches.sort(function(a,b){return a.time.getTime()-b.time.getTime();});var recent3=pastMatches.slice(0,3).reverse();var upcoming3=futureMatches.slice(0,3);var result=recent3.concat(upcoming3);if(result.length<6){var allSorted=allMatches.sort(function(a,b){return a.absDiff-b.absDiff;});for(var i=0;i<allSorted.length&&result.length<6;i++){var dup=false;for(var j=0;j<result.length;j++){if(result[j].m.id===allSorted[i].m.id){dup=true;break;}}if(!dup)result.push(allSorted[i]);}}return result.slice(0,6);}
function rNM(){var grid=document.getElementById('groupsGrid');var nearby=getNearbyMatches();var h='';if(nearby.length===0){h='<div style="padding:40px;text-align:center;color:var(--text-secondary);">暂无邻近比赛</div>';}else{h+='<div class="group-card" data-group="nearby"><div class="group-header"><span class="group-badge">📍</span> 邻近比赛</div><div class="match-list">';nearby.forEach(function(item){var m=item.m;var mk='2026|'+m.gid+'|'+m.home.code+'|'+m.away.code;var fin=(typeof wc2026MatchDetails!=='undefined'&&wc2026MatchDetails[mk]);if(fin){var fs=fin.score||{sh:'?',sa:'?'};h+='<div class="match-item finished" data-match-id="'+m.id+'" onclick="showMatchDetail(\'2026\',\''+m.gid+'\',\''+m.home.code+'\',\''+m.away.code+'\',false)" title="点击查看比赛详情"><span class="match-time">'+m.time+'</span>'+tdb(m.home.code,'home')+'<span class="vs-badge">VS</span>'+tdb(m.away.code,'away')+'<div class="score-input-group" style="background:rgba(212,168,67,0.15);border-radius:4px;padding:2px 0;"><span style="width:34px;text-align:center;font-weight:800;color:var(--gold-light);font-size:0.85rem;">'+fs.sh+'</span><span class="score-colon">:</span><span style="width:34px;text-align:center;font-weight:800;color:var(--gold-light);font-size:0.85rem;">'+fs.sa+'</span></div><span class="predict-indicator"></span><button class="btn btn-analysis" onclick="event.stopPropagation();showA(\''+m.id+'\')">📋阵容</button><button class="btn btn-venue" onclick="event.stopPropagation();showVenueAnalysis(\''+m.id+'\')">🏟️赛场</button><button class="btn btn-prob" onclick="event.stopPropagation();calcP(\''+m.id+'\')">📊概率</button><button class="btn btn-eval" onclick="event.stopPropagation();showMatchEval(\''+mk+'\')">🎮评价</button></div>';}else{var p=gPreds[m.id]||{};var is=m.id===selMid;var ip=p.sh!=null&&p.sa!=null;var sh=p.sh??'',sa=p.sa??'';var wn=p.w==='home'?m.home.zh:p.w==='away'?m.away.zh:p.w==='draw'?'平局':'';h+='<div class="match-item'+(is?' selected':'')+(ip?' predicted':'')+'" data-match-id="'+m.id+'" onclick="selM(\''+m.id+'\')"><span class="match-time">'+m.time+'</span>'+tdb(m.home.code,'home')+'<span class="vs-badge">VS</span>'+tdb(m.away.code,'away')+'<div class="score-input-group" onclick="event.stopPropagation();"><input type="number" class="score-input" min="0" max="20" placeholder="-" value="'+sh+'" onchange="uGS(\''+m.id+'\',\'home\',this.value)" onfocus="selM(\''+m.id+'\')"><span class="score-colon">:</span><input type="number" class="score-input" min="0" max="20" placeholder="-" value="'+sa+'" onchange="uGS(\''+m.id+'\',\'away\',this.value)" onfocus="selM(\''+m.id+'\')"></div><span class="predict-indicator">'+(ip?'✅ '+wn:'')+'</span><button class="btn btn-analysis" onclick="event.stopPropagation();showA(\''+m.id+'\')">📋阵容</button><button class="btn btn-venue" onclick="event.stopPropagation();showVenueAnalysis(\''+m.id+'\')">🏟️赛场</button><button class="btn btn-prob" onclick="event.stopPropagation();calcP(\''+m.id+'\')">📊概率</button></div>';}});h+='</div></div>';}grid.innerHTML=h;}
function rGM(){if(cGT==='nearby'){rNM();return;}const grid=document.getElementById('groupsGrid');let h='';const se=document.getElementById('searchInput').value.trim().toLowerCase();groupsData.forEach(g=>{if(cGT!=='all'&&g.id!==cGT&&!se)return;let ms=mByGroup[g.id];if(se){ms=ms.filter(m=>m.home.zh.toLowerCase().includes(se)||m.home.code.toLowerCase().includes(se)||m.away.zh.toLowerCase().includes(se)||m.away.code.toLowerCase().includes(se));}if(ms.length===0)return;const pc=ms.filter(m=>{const p=gPreds[m.id];return p&&p.sh!=null&&p.sa!=null;}).length;h+='<div class="group-card" data-group="'+g.id+'"><div class="group-header"><span class="group-badge">'+g.name+'</span> '+g.name+' 小组赛<span style="margin-left:auto;font-size:0.75rem;color:var(--text-secondary);">已预测 '+pc+'/6</span></div>'+rSP(g.id)+'<div class="match-list">'+ms.map(m=>{var mk='2026|'+m.gid+'|'+m.home.code+'|'+m.away.code;var fin=(typeof wc2026MatchDetails!=='undefined'&&wc2026MatchDetails[mk]);if(fin){var fs=fin.score||{sh:'?',sa:'?'};return '<div class="match-item finished" data-match-id="'+m.id+'" onclick="showMatchDetail(\'2026\',\''+m.gid+'\',\''+m.home.code+'\',\''+m.away.code+'\',false)" title="点击查看比赛详情"><span class="match-time">'+m.time+'</span>'+tdb(m.home.code,'home')+'<span class="vs-badge">VS</span>'+tdb(m.away.code,'away')+'<div class="score-input-group" style="background:rgba(212,168,67,0.15);border-radius:4px;padding:2px 0;"><span style="width:34px;text-align:center;font-weight:800;color:var(--gold-light);font-size:0.85rem;">'+fs.sh+'</span><span class="score-colon">:</span><span style="width:34px;text-align:center;font-weight:800;color:var(--gold-light);font-size:0.85rem;">'+fs.sa+'</span></div><span class=\"predict-indicator\"></span><button class=\"btn btn-analysis\" onclick="event.stopPropagation();showA(\''+m.id+'\')">📋阵容</button><button class="btn btn-venue" onclick=\"event.stopPropagation();showVenueAnalysis(\''+m.id+'\')\">🏟️赛场</button><button class="btn btn-prob" onclick="event.stopPropagation();calcP(\''+m.id+'\')">📊概率</button><button class=\"btn btn-eval\" onclick=\"event.stopPropagation();showMatchEval(\''+mk+'\')\">🎮评价</button></div>';}const p=gPreds[m.id]||{};const is=m.id===selMid;const ip=p.sh!=null&&p.sa!=null;const sh=p.sh??'',sa=p.sa??'';const wn=p.w==='home'?m.home.zh:p.w==='away'?m.away.zh:p.w==='draw'?'平局':'';return '<div class="match-item'+(is?' selected':'')+(ip?' predicted':'')+'" data-match-id="'+m.id+'" onclick="selM(\''+m.id+'\')"><span class="match-time">'+m.time+'</span>'+tdb(m.home.code,'home')+'<span class="vs-badge">VS</span>'+tdb(m.away.code,'away')+'<div class="score-input-group" onclick="event.stopPropagation();"><input type="number" class="score-input" min="0" max="20" placeholder="-" value="'+sh+'" onchange="uGS(\''+m.id+'\',\'home\',this.value)" onfocus="selM(\''+m.id+'\')"><span class="score-colon">:</span><input type="number" class="score-input" min="0" max="20" placeholder="-" value="'+sa+'" onchange="uGS(\''+m.id+'\',\'away\',this.value)" onfocus="selM(\''+m.id+'\')"></div><span class="predict-indicator">'+(ip?'✅ '+wn:'')+'</span><button class="btn btn-analysis" onclick="event.stopPropagation();showA(\''+m.id+'\')">📋阵容</button><button class="btn btn-venue" onclick=\"event.stopPropagation();showVenueAnalysis(\''+m.id+'\')\">🏟️赛场</button><button class="btn btn-prob" onclick="event.stopPropagation();calcP(\''+m.id+'\')">📊概率</button></div>';}).join('')+'</div></div>';});grid.innerHTML=h||'<div style="padding:40px;text-align:center;color:var(--text-secondary);">未找到匹配的球队</div>';}
...
window.updateOddsFromBookmakers=function(){
    ...
    setTimeout(()=>{
        ...
        const teamStats={};
        const allOdds=Object.assign({},matchOdds,window.knockoutOdds||{},window.knockoutOddsR16||{},window.knockoutOddsQF||{},window.knockoutOddsSF||{},window.knockoutOddsTP||{},window.knockoutOddsFINAL||{});
        ...
        if(info)info.innerHTML='<span class=\"source-tag source-william\">William Hill</span> 数据更新于 '+lastUpdate.toLocaleString('zh-CN')+' | 数据来源: The Odds API (72场小组赛 + 16场R32 + 8场R16 + 4场QF淘汰赛)';
        btn.disabled=false;
        btn.textContent='🔄 刷新概率数据';
        showToast('✅ William Hill 概率数据已更新 (72场小组赛 + 16场R32 + 8场R16 + 4场QF淘汰赛)');
    },800);
};
...
function rtc(t,d,sd){
  ...
  var _tParts=(m.time||'').replace('月','/').replace('日','').split(' ');var _dateRaw=_tParts[0]||'';var _timeStr=_tParts[1]||'';var _dp=_dateRaw.split('/');var _month=_dp[0]||'';var _day=_dp[1]||'';var _dateStr=(_month.length<2?'0'+_month:_month)+'/'+(_day.length<2?'0'+_day:_day);var fmHome=hd&&hd.f?rFD(hd.f,m.home.code):'';var fmAway=ad&&ad.f?rFD(ad.f,m.away.code):'';ct.innerHTML='<div style="display:grid;grid-template-columns:1fr auto 1fr;gap:8px;padding:16px;border-bottom:1px solid rgba(255,255,255,0.05)">'+rtc(m.home,hd,'home')+'<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 4px"><div class="vs-badge-refined">VS</div><div style="font-size:0.6rem;color:#777;margin-top:6px">'+m.gn+'</div><div class="info-badge">'+_dateStr+'</div><div class="info-time">'+_timeStr+'</div></div>'+rtc(m.away,ad,'away')+'</div>'+(fmHome&&fmAway?'<div style="padding:10px 16px 0;text-align:center"><div class="fm-section-header" style="color:#d4a020">📐 预计阵型</div></div><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;padding:4px 16px 12px"><div style="text-align:center"><div class="section-title" style="text-align:center;margin-bottom:2px">'+m.home.zh+' · '+hd.f+'</div>'+fmHome+'<div class="pitch-annotation"></div></div><div style="text-align:center"><div class="section-title" style="text-align:center;margin-bottom:2px">'+m.away.zh+' · '+ad.f+'</div>'+fmAway+'<div class="pitch-annotation"><span>← </span><span> →</span></div></div></div>':'')+h2hHtml+'<div class="src-footer">数据来源: FIFA | AI分析仅供参考</div>';
...
function rKP(){bKT();const ct=document.getElementById('koContent');let h='';koRounds.forEach(r=>{const ms=koByStage[r.id]||[];h+='<div class="ko-round-section'+(cKR===r.id?' active':'')+'" data-koround="'+r.id+'"><div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(380px,1fr));gap:12px;">'+ms.map(m=>{const p=kPreds[m.id]||{};const tA=p.tA||null,tB=p.tB||null;var sh=p.sA??'',sa=p.sB??'';var isFinished=false;var mk=null;if(tA&&tB){mk='2026|'+m.sid+'|'+tA+'|'+tB;var fin=lookupMatchData(m.sid,tA,tB);if(fin){var es=fin.score120||fin.score;var isTAFirst=!!((typeof wc2026MatchDetails!=='undefined'&&wc2026MatchDetails['2026|'+m.sid+'|'+tA+'|'+tB])||((window.wc2026AllMatches||{})['2026|'+m.sid+'|'+tA+'|'+tB]));if(isTAFirst){sh=es.sh;sa=es.sa;}else{sh=es.sa;sa=es.sh;}isFinished=true;}}const wn=p.w==='teamA'?(teamMap[tA]?.zh||''):p.w==='teamB'?(teamMap[tB]?.zh||''):p.w==='draw'?'平局':'';if(isFinished){return '<div class="match-item finished" onclick="showMatchDetail(\'2026\',\''+m.sid+'\',\''+tA+'\',\''+tB+'\',true)" title="点击查看比赛详情"><span class="match-time">'+m.time+'</span>'+tdb(tA,'home')+'<span class="vs-badge">VS</span>'+tdb(tB,'away')+'<div class="ko-match-row2"><div class="score-input-group" style="background:rgba(212,168,67,0.15);border-radius:4px;padding:2px 0;"><span style="width:34px;text-align:center;font-weight:800;color:var(--gold-light);font-size:0.85rem;">'+sh+'</span><span class="score-colon">:</span><span style="width:34px;text-align:center;font-weight:800;color:var(--gold-light);font-size:0.85rem;">'+sa+'</span></div><span class="predict-indicator"></span><button class="btn btn-analysis" onclick="event.stopPropagation();showA_ko(\''+m.id+'\',\''+(tA||'')+'\',\''+(tB||'')+'\')">📋阵容</button><button class="btn btn-venue" onclick="event.stopPropagation();showVenue_ko(\''+m.id+'\',\''+(tA||'')+'\',\''+(tB||'')+'\')">🏟️赛场</button><button class="btn btn-prob" onclick="event.stopPropagation();calcP_ko(\''+m.id+'\',\''+(tA||'')+'\',\''+(tB||'')+'\')">📊概率</button><button class="btn btn-eval" onclick="event.stopPropagation();showMatchEval(\''+mk+'\')">🎮评价</div></button></div>';}return '<div class="ko-match'+(isFinished?' finished':'')+'"><span class="match-time">'+m.time+'</span><div class="ko-team" onclick="eKT(event,\''+m.id+'\',\'tA\')"><div class="display">'+tdb(tA,'home')+'</div><select onchange="uKT(\''+m.id+'\',\'tA\',this.value)" onclick="event.stopPropagation();"><option value="">-- 选择 --</option>'+allTeams.map(t=>'<option value="'+t.code+'" '+(tA===t.code?'selected':'')+'>'+t.zh+'</option>').join('')+'</select></div><span class="vs-badge">VS</span><div class="ko-team" onclick="eKT(event,\''+m.id+'\',\'tB\')"><div class="display">'+tdb(tB,'away')+'</div><select onchange="uKT(\''+m.id+'\',\'tB\',this.value)" onclick="event.stopPropagation();"><option value="">-- 选择 --</option>'+allTeams.map(t=>'<option value="'+t.code+'" '+(tB===t.code?'selected':'')+'>'+t.zh+'</option>').join('')+'</select></div><div class="ko-match-row2"><div class="ko-score-group" onclick="event.stopPropagation();"><input type="number" class="score-input" min="0" max="20" placeholder="-" value="'+sh+'" onchange="uKS(\''+m.id+'\',\'sA\',this.value)"><span class="score-colon">:</span><input type="number" class="score-input" min="0" max="20" placeholder="-" value="'+sa+'" onchange="uKS(\''+m.id+'\',\'sB\',this.value)"></div><span class="predict-indicator">'+(p.w?'✅ '+wn:'')+'</span><div class="ko-actions" style="display:flex;gap:4px;margin-top:6px;flex-wrap:wrap"><button class="btn btn-analysis" onclick="event.stopPropagation();showA_ko(\''+m.id+'\',\''+(tA||'')+'\',\''+(tB||'')+'\')">📋阵容</button><button class="btn btn-venue" onclick="event.stopPropagation();showVenue_ko(\''+m.id+'\',\''+(tA||'')+'\',\''+(tB||'')+'\')">🏟️赛场</button><button class="btn btn-prob" onclick="event.stopPropagation();calcP_ko(\''+m.id+'\',\''+(tA||'')+'\',\''+(tB||'')+'\')">📊概率</button></div></div></div>';}).join('')+'</div></div>';});ct.innerHTML=h;}
...
['summaryModal','probModal','analysisModal'].forEach(id=>{var el=document.getElementById(id);if(el)el.addEventListener('click',function(e){if(e.target===this){if(id==='summaryModal')closeSummaryModal();if(id==='probModal')closeProbModal();if(id==='analysisModal')closeAnalysisModal();}});});
...
window.makePlayerClickable = function(displayName) {
    ...
    // ★ V1.74 修复: 如果 key 为空且 displayName 包含括号，提取英文名作为回退
...
window.searchPlayer = function() {
    ...
    if (matches.length === 1) {
        // V1.74 增强相关性验证：短查询(≤3字符)要求更高相关性，避免子串误匹配
    ...
    // 尝试在比赛数据中搜索 scorer（V1.74: 仅当查询≥3字符且匹配整个单词时才触发，避免误匹配）
